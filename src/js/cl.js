...
import { renderSteps } from './app/stepscl'
import { renderErrors } from './lib/errors'
import { renderNavLinks } from './app/navigationcl'
...
window.addEventListener('DOMContentLoaded', async () => {
	...
	dataLayer.push({ 'tipoPagina': 'lbel', 'pais': 'CL' })
	...
	await loginWithUrl('CL')

	buttonLogin.onclick = async (event) => {

		event.preventDefault()
		await loginWithBtn('CL', event)
